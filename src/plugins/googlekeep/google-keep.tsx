...
const PictureConfigScreen = ({
  ...
  const [url, setUrl] = useState(
    currentConfig?.url ?? "https://keep.google.com/"
  );
  ...
  return (
    <div className="PictureWidget">
      <button id="gmeet" onClick={redirect2}>
        <img
          src="https://logowik.com/content/uploads/images/google-keep3448.jpg"
          alt="keep"
          width="80%"
        />
      </button>
...
const widgetDescriptor = {
  id: "widget",
  get name() {
    return translate("google-keep.widgetName");
  },
  configurationScreen: PictureConfigScreen,
  mainScreen: GooglekeepPlugin,
  mock: () => {
    return (
      <GooglekeepPlugin
        instanceId="mock"
...
export const googlekeepPlugin = {
  id: "google-keep",
  get name() {
    return translate("google-keep");
  },
